...
def render_edit_comparison(arrays, edit, resolved, config, output_dir):
    ...
    for row, (fixed, x, y, name) in enumerate(specs):
        ...
        for column in range(3):
            ...
            heading = ['Before: original tissue', 'After: reassigned tissue', 'Changes on ORIGINAL attenuation'][column]
    ...
    fig.text(.5, .009, 'Source volumes are preserved. Geometry/label trial only; no recovered CT is shown.', ha='center', fontsize=10)
